...
const rootReducer = (state=initialState, action)=>{
    switch (action.type) {
        case 'GET_COUNTRIES':
            return {
                ...state, renderCountries: action.payload,
                countries: action.payload
            }

        case 'FILTER_CONTINENT':
            const allCountries = state.countries;
            const filtered = action.payload === 'wrld'
                ? allCountries 
                : allCountries.filter(c => c.continent === action.payload)
            return {
                ...state, renderCountries: filtered
            }
        ...
        case 'ORDER_NAME':
            ...
            const orderedName = action.payload === 'A-Z'
                ...
                ;
            return {
                ...state, renderCountries: orderedName
            }
        ...
        case 'ORDER_POPULATION':
            ...
            return {
                ...state, renderCountries: orderedPop
            }
