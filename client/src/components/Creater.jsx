...
import cinema from './styles/images/cinema.png'
import holidays from './styles/images/holidays.png'
...
const validation = (input)=>{
    ...
    if(!input.name){
        ...
        errors.difficulty = 'Set your difficulty'
    ...
    return (
        <div className={styles.container}>
            ...
            <form className={styles.form}
                ...
                <img src={cinema} alt="sticker" className={styles.stick1} />
                <img src={holidays} alt="sticker" className={styles.stick2} />
                <img src={meditation} alt="sticker" className={styles.stick3} />
                <img src={relax} alt="sticker" className={styles.stick4} />  
            </form>
        </div>
    )
}
